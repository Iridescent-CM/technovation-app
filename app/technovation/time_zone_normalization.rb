...
# Maps legacy IANA timezone identifiers to their canonical names.
# Generated from https://github.com/eggert/tz/blob/main/backward (Link lines).
module TimeZoneNormalization
  MAPPING = {
  ...
  def normalize(name)
    ...
    return canonical if Time.find_zone(canonical)
    return name if canonical != name && Time.find_zone(name)
