  ...
  <ol v-else>
    ...
    >
      ...
      <div
        ...
        "
        class="border-l-2 border-energetic-blue bg-blue-50 p-2 my-4"
      >
        <div class="help-text text-base font-normal">
          <h4 class="mb-4 text-xl">Judging Guidance</h4>
          <p>Please keep the following in mind for this question:</p>

          <h5 class="mt-4 text-normal">
            If the team does not mention AI at all
          </h5>
          <p class="my-2">Award a 1.</p>

          <h5 class="mt-4 text-normal">If the team did not use AI</h5>
          <p class="my-2">
            A simple mention of not using AI without any reason why should be a
            3. If they talk about not using AI and why they chose not to, that
            is a 4 or 5, dependent on detail.
          </p>

          <h5 class="mt-4 text-normal">If the team did use AI</h5>
          <p class="my-2">
            A simple mention of using AI without reason why or details should be
            a 3. If they talk about how they used AI and why it was useful,
            award a 4 or 5, dependent on detail.
          </p>
        </div>
      </div>
