<template>
  <div>
    ...
    <h3 class="mt-8 mb-2 font-semibold">
      {{ commentTitle | capitalize }} Feedback for Students
    </h3>
    ...
    <div class="flex justify-between mb-1 ml-1 mr-2">
      <p class="text-base italic">
        Please write between {{ minWordCount }} and {{ maxWordCount }} words
      </p>
    ...
    <div class="flex justify-between mt-12">
      <div>
        <router-link
          ...
          @click.native="handleCommentChange"
        >
          Back
        </router-link>
      </div>
...
export default {
  ...
  computed: {
    ...
    colorForWordCount() {
      if (
        this.wordCount >= this.minWordCount &&
