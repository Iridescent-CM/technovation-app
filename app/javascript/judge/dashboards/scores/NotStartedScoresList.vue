<template>
  <div class="mb-4">
    <div v-if="notStartedSubmissions.length">
      <p class="mb-4">
        Begin scoring your submissions. You will be able to edit your scores
        until the current round of judging closes.
        <span v-if="isLiveJudge"
          >For more information about your events, please view your dashboard.
        </span>
      </p>

      <h2
        class="text-base text-energetic-blue font-semibold tracking-wide uppercase"
      >
        {{ title }}
      </h2>
    ...
    <div v-else>
      <p v-if="isLiveJudge">
        You currently do not have any new submissions to score. Please contact
        your chapter ambassador if this is a mistake.
      </p>
      <p v-else>To start a new score, complete any scores in progress.</p>
    </div>
  </div>
</template>
