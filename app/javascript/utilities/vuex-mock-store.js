...
export default class VuexMockStore {
  constructor(
    overrides = { state: {}, getters: {}, mutations: {}, actions: {} }
  ) {
    if (!this.isObject(overrides.state)) overrides.state = {};

    if (!this.isObject(overrides.getters)) overrides.getters = {};

    if (!this.isObject(overrides.mutations)) overrides.mutations = {};

    if (!this.isObject(overrides.actions)) overrides.actions = {};
