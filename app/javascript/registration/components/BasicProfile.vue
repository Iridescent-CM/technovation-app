<template>
  <form class="panel panel--contains-bottom-bar panel--contains-top-bar">
    <div class="panel__top-bar">Basic Profile</div>
    ...
    <div class="panel__content">
      ...
      <p v-show="isGenderRequired" class="section">
      ...
      <p class="section">
        ...
        <input id="schoolName" v-model="schoolCompanyName" type="text" />
      </p>
      ...
      <div v-show="profileChoice == 'mentor'">
        ...
        <div class="section">
          ...
          <p>
            ...
            to know you. You can change this later.
          </p>
          <label for="bio"> Tell the students about yourself </label>
      ...
      <p class="section">
        <label for="referredBy"
          >How did you hear about Technovation? (optional)</label
        >
        <vue-select
          v-model="referredBy"
          :select-on-tab="true"
...
export default {
  ...
  computed: {
    ...
    saveLabel() {
      if (this.saved) return "All your changes have been saved!";
