# FIXME: This causes smtp delivery to fail, workaround here is to require within the task.
# See: https://github.com/mailgun/mailgun-ruby/issues/86
# require 'mailgun-ruby'

namespace :mailgun do
  task check_ready_submissions: :environment do
    require 'mailgun-ruby'  # See FIXME at top
