...
RSpec.describe ParentalConsentsController do
  describe "POST #create" do
    it "preserves the token on a validation error" do
      ...
      post :create, parental_consent: { student_profile_consent_token: student.consent_token }
    ...
    it "emails a copy to the parent" do
      student = FactoryGirl.create(:student, :full_profile)
      post :create, parental_consent: FactoryGirl.attributes_for(:parental_consent, student_profile_consent_token: student.consent_token)
