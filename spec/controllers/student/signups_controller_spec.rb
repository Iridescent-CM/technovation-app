...
RSpec.describe Student::SignupsController do
  before do
    controller.set_cookie(:signup_token, SignupAttempt.create!(email: "invited@thanks.com", password: "secret1234", status: SignupAttempt.statuses[:active]).signup_token)
  end
