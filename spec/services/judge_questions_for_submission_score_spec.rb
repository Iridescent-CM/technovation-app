...
describe JudgeQuestionsForSubmissionScore do
  ...
  describe "#call" do
    ...
    before do
      allow(Judging::TwentyTwo::BeginnerQuestions).to receive_message_chain(:new, :call).and_return(questions)
  ...
  describe "getting the correct questions for a given season and division" do
    before do
      allow(Judging::TwentyTwo::SeniorQuestions).to receive_message_chain(:new, :call).and_return([])
      allow(Judging::TwentyTwo::JuniorQuestions).to receive_message_chain(:new, :call).and_return([])
      allow(Judging::TwentyTwo::BeginnerQuestions).to receive_message_chain(:new, :call).and_return([])
    end
    ...
    context "when it's the 2022 season" do
      ...
      context "when it's the senior division" do
        ...
        it "calls the appropriate class to get the 2022 senior questions" do
          expect(Judging::TwentyTwo::SeniorQuestions).to receive_message_chain(:new, :call)
      ...
      context "when it's the junior division" do
        ...
        it "calls the appropriate class to get the 2022 junior questions" do
          expect(Judging::TwentyTwo::JuniorQuestions).to receive_message_chain(:new, :call)
      ...
      context "when it's the beginner division" do
        ...
        it "calls the appropriate class to get the 2022 beginner questions" do
          expect(Judging::TwentyTwo::BeginnerQuestions).to receive_message_chain(:new, :call)
